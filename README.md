...
[![My Skills](https://skillicons.dev/icons?i=cpp,cs,python,js,ts,golang,dotnet,maven,hibernate,angular,react,nextjs,nodejs,express,fastapi,django,mysql,postgres,mongodb,redis,aws,azure,git,github,linux,docker,kubernetes,jenkins,prometheus,grafana,kafka,bash)](https://skillicons.dev)
