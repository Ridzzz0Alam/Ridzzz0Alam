...
[![My Skills](https://skillicons.dev/icons?i=cpp,csharp,python,js,ts,golang,spring,maven,hibernate,angular,react,nextjs,nodejs,express,fastapi,django,mysql,postgres,mongodb,redis,aws,azure,git,github,linux,docker,kubernetes,jenkins,prometheus,grafana,kafka,bash)](https://skillicons.dev)
