...
[![My Skills](https://skillicons.dev/icons?i=java,python,js,ts,go,angular,react,nextjs,nodejs,express,django,fastapi,spring,postgres,mongodb,aws,azure,git,github,linux,docker,kubernetes,jenkins,prometheus,grafana,terraform,ansible)](https://skillicons.dev)
