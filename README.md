...
|---------|-------------|------------|
| [News Category Classifier Multiclass Text Classification](https://github.com/Ridzzz0Alam/News-Category-Classifier-Multiclass-Text-Classification) | A privacy first notes application with server side AI summarisation, automatic tagging, and retrieval-augmented (RAG) chat grounded exclusively in the user's own notes. | Python, Scikit-learn, Pandas, Numpy, Matplotlib, Seaborn, Google Collab |
